...
// StateHistoryHandler is a function type that processes the message history with access to the current state.
type StateHistoryHandler func(ctx context.Context, history []*Message, state *State) ([]*Message, error)
