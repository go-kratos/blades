module github.com/go-kratos/blades/contrib/minimax
...
replace (
	...
	github.com/go-kratos/blades/contrib/anthropic => ../anthropic
	github.com/go-kratos/blades/contrib/openai => ../openai
)
